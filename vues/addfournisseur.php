      ...
      <div class="row">
          ...
          <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
              <div class="text-center custom-login">
                  ...
                  <p style="color: white;">Bienvenue Sur L' Interface Fournisseur</p>
              </div>
              <div class="hpanel">
                  <div class="panel-body">
                    ...
                    <form action="" id="loginForm" method="POST" >
                      <div class="row">
                        <!-- <script src="script.js"></script> -->
                          ...
                          <div class="form-group col-lg-6">
                              ...
                              <input type="text" name="telephone" class="form-control" placeholder="Entrez Le Numero De Telephone">
                          </div>
                          <div class="form-group col-lg-6">
                            <label>Email </label>
                      ...
                      <div class="text-center">
                          <button type="submit" name="valider" class="btn btn-success loginbtn">Register</button>
