      ...
      <div class="row">
          ...
          <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
              <div class="text-center custom-login">
                  <h3 style="color: white;">Suppression Fournisseur</h3>
              </div>
              <div class="hpanel">
                  <div class="panel-body">
                    <!--particule js-->
                    <form action="" id="loginForm" method="POST">
                      voulez vraiment supprimer ce fournisseur?
                      <div class="text-center">
                          <button type="submit" name="valider" class="btn btn-success loginbtn">oui</button>
                          <a href="index.php?page=listfournisseur" class="btn btn-default">Non</button>
                      </div>
                  </form>
                  </div>
              </div>
