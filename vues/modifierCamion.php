              ...
              <div class="hpanel">
                  <div class="panel-body">
                    ...
                    <form action="" id="loginForm" method="POST">
                      <div class="row">
                      <?php foreach($detailcamion as $data) { ?>
                        <!-- <script src="script.js"></script> -->
                          ...
                          <div class="form-group col-lg-6">
                              ...
                              <input type="text" name="immatriculation" class="form-control" placeholder="Entrez l' immatriculation" value="<?php echo $data['immatriculation']; ?>">
                          </div>
                          <?php } ?> 
                      </div>
